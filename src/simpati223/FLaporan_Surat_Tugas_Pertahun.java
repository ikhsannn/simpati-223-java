 ...
 */
public class FLaporan_Surat_Tugas_Pertahun extends javax.swing.JInternalFrame {

    /**
     * Creates new form FLaporan_Surat_Keterangan_Pertahun
     */
    public FLaporan_Surat_Tugas_Pertahun() {
        initComponents();
        TampilData();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laporan Surat Tugas Pertahun");
   ...
   public void TampilData() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String filePath = "C:\\simpati223\\laporan_surat_tugas_tahun_"+date+".pdf";
            ...
            if (!file.exists()) {
                try {
                    ...
                    if (created) {
                        ...
                        Paragraph para = new Paragraph("Laporan Surat Tugas Tahun "+date, boldFont);
