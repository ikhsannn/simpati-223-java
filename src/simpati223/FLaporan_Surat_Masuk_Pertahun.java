 ...
 */
public class FLaporan_Surat_Masuk_Pertahun extends javax.swing.JInternalFrame {

    /**
     * Creates new form FLaporan_Surat_Masuk_Pertahun
     */
    public FLaporan_Surat_Masuk_Pertahun() {
        initComponents();
        TampilData();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Laporan Surat Masuk Pertahun");
   ...
   public static void lockJTableColumnWidth(TableColumn tc, int pixels) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String filePath = "C:\\simpati223\\laporan_surat_masuk_tahun_"+date+".pdf";
            ...
            if (!file.exists()) {
                try {
                    ...
                    if (created) {
                        ...
                        Paragraph para = new Paragraph("Laporan Surat Masuk Tahun "+date, boldFont);
                        ...
                        table.addCell(new PdfPCell(new Phrase("Asal Surat", headerFont)));
                        table.addCell(new PdfPCell(new Phrase("Perihal", headerFont)));

                        //we generate data from table surat_masuk
                        java.sql.Statement stmt = conn.createStatement();
                        int no = 0;
                        String SQL = "select * from surat_masuk where YEAR(tgl_surat) = '"+date+"'";
                        java.sql.ResultSet res = stmt.executeQuery(SQL);
                        ...
                        while (res.next()) {
                            ...
                            table.addCell(new PdfPCell(new Phrase(""+res.getString("asal_surat"), bodyFont)));
    ...
    private void jButton1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton1KeyPressed
        ...
        //        if(evt.getKeyCode() == java.awt.event.KeyEvent.VK_ENTER){
            ...
            //            try {
                ...
                //                String filePath = "C:\\simpati223\\laporan_surat_masuk_bulan_"+Fungsi.getMonthName(date)+".pdf";
                //
                //                // Check if folder exists, create if it doesn't
                //                File folder = new File(folderPath);
                //                if (!folder.exists()) {
                ...
                //                if (!file.exists()) {
                    //                    try {
                        ...
                        //                        if (created) {
                            ...
                            //                            //created a title from pdf
                            //                            Font boldFont = new Font(Font.FontFamily.TIMES_ROMAN, 17, Font.BOLD);
                            //                            Paragraph para = new Paragraph("Laporan Surat Masuk Bulan "+Fungsi.getMonthName(date)+" "+Fungsi.getYear(date), boldFont);
                            //                            para.setAlignment(Element.ALIGN_CENTER);
                            //
                            //                            document.add(para);
                            //
                            ...
                            //                            java.sql.Statement stmt = conn.createStatement();
                            //                            int no = 0;
                            //                            String SQL = "select * from surat_masuk where DATE_FORMAT(tgl_surat, '%Y-%m') = '"+date+"'";
                            //                            java.sql.ResultSet res = stmt.executeQuery(SQL);
                            //                            Font bodyFont = new Font(Font.FontFamily.TIMES_ROMAN, 10);
                            //                            while (res.next()) {
                                //                                no++;
                ...
                //            } catch (Exception e) {
                //                System.out.println(e);
                //                JOptionPane.showMessageDialog(null, "Data gagal dicetak", "Pesan", JOptionPane.INFORMATION_MESSAGE);
                //            }
            //        }
